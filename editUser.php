    ...
    <table width="444" border="1" align="center">
        ...
        <tr>
            ...
            <td><input type="radio" name="sex" value="男"
                    <?php if ($user['sex'] == '1') echo "checked=\"checked\"" ?> /> 男<input type="radio" name="sex"
                                                                                            value="女" <?php if ($user['sex'] == '2') echo "checked=\"checked\"" ?>
                /> 女
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                ...
                $birday_m = date('m', strtotime($user['birthday']));
                $birday_d = date('d', strtotime($user['birthday']));
                ?>
